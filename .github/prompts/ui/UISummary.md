...
Końcowy wynik koniecznie powinien zawierać tylko treść w formacie markdown jako twoją odpowiedź. Upewnij się, że Twoje podsumowanie jest jasne, zwięzłe i zapewnia wzystkie cenne informacje dla następnego etapu planowania architektury UI i integracji z API.

Podsumowanie w formacie markdown:

```markdown
Tutaj będzie Twoje podsumowanie rozmowy w formacie markdown.
```